...
export const t = {
  ...
  filesNoPreview: 'Nessuna anteprima per questo tipo di file: usa Scarica.',
  filesTooBig: 'File troppo grande per l\'anteprima (>2 MB): usa Scarica.',
  filesHint: 'Share e dischi via SFTP (fallback SSH), percorsi sotto /mnt. Immagini, video, audio, PDF e testo si aprono direttamente; il resto si scarica.',
