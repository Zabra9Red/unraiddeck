...
- **Consumo elettrico dall'UPS**: potenza assorbita (misurata via `ups.realpower` o stimata da potenza nominale × carico), integrata in kWh per oggi/7g/30g/anno con grafico orario, e **costo in €** col prezzo €/kWh della tua bolletta (preset indicativi dei principali fornitori italiani — Enel, Eni Plenitude, Edison, A2A, Iren, Sorgenia, Octopus — o valore manuale).
